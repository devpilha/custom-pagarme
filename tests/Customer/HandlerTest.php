    ...
    **/
    public function mustReturnArrayOfCustomers()
    {
        ...
        $clientMock->method('send')
            ->willReturn(json_decode(self::LIST_RESPONSE));
